(function (root, factory) {
    ...
    Container.prototype = {
         ...
         * @param {String}
         *            containerSubscriptionId Container's ID for a
         *            subscription, from previous call to
         *            subscribeForClient()
         */
         ...
         * disconnects container from HubClient - unsubscribes from all of
         * its existing subscriptions in the ManagedHub
         *
         * This function is only called by ManagedHub.removeContainer
         * Calling this function does NOT cause the container's onDisconnect
        ...
        /**
         * Returns the clientID passed in when this Container was
         * instantiated.
         *
         ...
         * associated with the window containing the HubClient associated
         * with this Container instance. The origin has the format
         *
         * [protocol]://[host]
         *
         * where:
         *
         * [protocol] is "http" or "https" [host] is the hostname of the
         * partner page.
         *
        ...
        /**
         * Returns the params object associated with this Container
         * instance. Allows mix-in code to access parameters passed into
         * constructor that created this Container instance.
         *
